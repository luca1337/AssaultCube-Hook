========================================================================
    LIBRERIA A COLLEGAMENTO DINAMICO: cenni preliminari sul progetto [AssaultCube Extension]
========================================================================

La Creazione guidata applicazione ha creato questa DLL [AssaultCube Extension].

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione [AssaultCube Extension].


[AssaultCube Extension].vcxproj
...
[AssaultCube Extension].vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato [AssaultCube Extension].pch e il file dei tipi precompilato StdAfx.obj.
